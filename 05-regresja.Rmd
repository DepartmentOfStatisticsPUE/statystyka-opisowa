...
Zależność wydatków od dochodów wydaje się oczywista - za $y$ przyjmiemy wydatki, a $x$ to będą dochody. Na wykresie ta zależność przedstawia się w następujący sposób:
...
Interesuje nas tworzenie modelu uproszającego rzeczywistość do poziomu wzoru na prostą, której ogólna postać jest następująca:
