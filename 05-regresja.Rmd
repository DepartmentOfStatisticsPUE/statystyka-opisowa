...
W celu stworzenia modelu opisującego taką zależność stosuje się Klasyczną Metodę Najmniejszych Kwadratów (KMNK), w której minimalizujemy odległość punktów od dopasowywanej prostej. Weźmy pod uwagę prosty przykład dochodów i wydatków:
...
Zależność wydatków od dochodów wydaje się oczywista i na wykresie będzie przedstawiała się w następujący sposób:
